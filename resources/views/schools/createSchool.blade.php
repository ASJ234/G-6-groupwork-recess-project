        ...
        <div class="col-md-8 mx-auto">
            <div class="card shadow-lg">
                ...
                <div class="card-header card-header-primary">
                    <h4 class="card-title">Upload School</h4>
                    <p class="card-category">Enter the details of the new school</p>
                </div>
                ...
                <div class="card-body">
                    <form action="{{ route('schools.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="representative_email" class="bmd-label-floating">Email</label>
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox" id="validated" name="validated" value="1" {{ old('validated') ? 'checked' : '' }}>
                                Validated
                        ...
                        <button type="submit" class="btn btn-primary btn-round pull-right">
                            <i class="material-icons">send</i> Upload School
                        </button>
